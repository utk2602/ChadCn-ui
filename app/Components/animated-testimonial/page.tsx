      ...
      <div className="absolute bottom-6 left-6 flex gap-1">
        {testimonials.map((_, index) => (
          <button
            ...
            className={\`h-2 w-2 rounded-full transition-colors \${index === activeIndex ? "bg-foreground" : "bg-muted-foreground/30"}\`}
            ...
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y">
                ...
                <tr>
                  ...
                  <td className="p-3">Automatically cycle through testimonials</td>
                </tr>
                <tr>
...
export default function MyComponent() {
  const testimonials = [
    { author: "John Doe", role: "CEO", content: "This product changed our business completely!" },
    { author: "Jane Smith", role: "Designer", content: "The best UI library I've ever used." }
  ]
