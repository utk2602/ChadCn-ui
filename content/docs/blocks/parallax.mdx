...
url: https://21st.dev/youcefbnm/parallax/default/?ref=systaliko-ui
---
...
<ComponentInstallation name="parallax" />
...
<TypeTable
  type={{
    start: {
      description: 'start position of the item ',
      type: 'number',
      required: true,
    },
    end: {
      description: 'end position of the item ',
      type: 'number',
      required: true,
    },
  }}
